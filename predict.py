...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='predict LM-BLSTM-CRF')
    ...
    predictor = predict_w(if_cuda, f_map, l_map, f_map['<eof>'], l_map['<pad>'], l_map['<start>'], args.batch_size)
    print('annotating')
