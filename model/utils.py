...
def read_corpus(lines, set_type="train"):
    """
...
def read_features(lines, multi_docs=False):
    """
...
def load_embedding_wlm(emb_file, delimiter, feature_map, full_feature_set, unk, emb_len,
